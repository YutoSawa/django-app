...
class GroupCheckForm(forms.Form):
    def __init__(self, user, *args, **kargs):
        super(GroupCheckForm, self).__init__(*args, **kargs)
...
class GroupSelectForm(forms.Form):
    def __init__(self,user, *args, **kargs):
        super(GroupSelectForm, self).__init__(*args, **kargs)
...
class FriendsForm(forms.Form):
    def __init__(self, user, friends=[], vals=[], *args, **kargs):
        super(FriendsForm, self).__init__(*args, **kargs)
